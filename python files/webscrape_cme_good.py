...
collection_out = os.path.join(out_folder, "collection")
...
completed.to_excel(os.path.join(out_folder, "correctly_collected_samples.xlsx"))
issues.to_excel(os.path.join(out_folder, "issues_samples.xlsx"))
